...
function onCreate()
    ...
    makeAnimatedLuaSprite('DodgeButton','IC_Buttons',51,343)
    addAnimationByPrefix('DodgeButton','Static','Dodge instance 1',24,true)
    addAnimationByPrefix('DodgeButton','NA','Dodge click instance 1',30,false)
    objectPlayAnimation('DodgeButton','Static',true)
    ...
    if getProperty('boyfriend.curCharacter') ~= 'BF_Sans_Chara' and getProperty('boyfriend.curCharacter') ~= 'BF_Sans_IC' and getProperty('boyfriend.curCharacter') ~= 'BF_Sans_Chara' then
        makeAnimatedLuaSprite('DodgeAlert','sans/Bone',getProperty('boyfriend.x') - 200,getProperty('boyfriend.y') - 50)
    ...
    if songName == 'Whoopee' or songName == 'Sansational' then
        makeAnimatedLuaSprite('DodgeAlert','sans/DodgeMechs',getProperty('boyfriend.x') - 225,getProperty('boyfriend.y') - 300)
        addAnimationByPrefix('DodgeAlert','alert','Alarm instance 1',24,false)
        addAnimationByPrefix('DodgeAlert','attack','Bones boi instance 1',24,false)
        --scaleObject('DodgeAlert',0.8,0.8)
    end
    ...
    if getProperty('boyfriend.curCharacter') == 'BF_Sans_IC' then
        makeAnimatedLuaSprite('BFSansDodge','sans/DodgeMechs',getProperty('boyfriend.x') - 5,getProperty('boyfriend.y'))
        addAnimationByPrefix('BFSansDodge','dodge','Dodge instance 1',24,false)
        characterSansDodgeFound = true
    end
...
function onEvent(name,value1,value2)
        ...
        if name == "SansDodge" then
            ...
            setProperty('DodgeAlert.y',getProperty('boyfriend.y') - 100)
            setProperty('DodgeAlert2.y',getProperty('boyfriend.y') - 50)
            triggerEvent('Camera Follow Pos',getProperty('boyfriend.x') - 100,getProperty('boyfriend.y') + 50)
            DodgeSans = 3
