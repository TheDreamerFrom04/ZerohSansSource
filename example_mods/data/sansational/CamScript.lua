...
local xx = 850; -- Code to change the position of the camera to the left or right for your opponent, Less = Left (They can be negative numbers), More = Right
local yy = 725; -- Code to change the position of the camera up or down for the enemy Less = Down (They can be negative numbers), More = Up
local xx2 = 1250; -- Same code as above, but for boyfriend left, right
local yy2 = 725; -- Same code as above, but for boyfriend up, down
