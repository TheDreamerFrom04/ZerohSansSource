	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				case 2:
					#if PSYCH_WATERMARKS
					createCoolText(['Indie Cross by'], 15);
					#else
				...
				case 4:
					#if PSYCH_WATERMARKS
					addMoreText('Moro Nighteye', 15);
					addMoreText('Brightfyre', 15);
					addMoreText('DAGames and more', 15);
					#else
					addMoreText('present');
					#end
				// credTextShit.text += '\npresent...';
